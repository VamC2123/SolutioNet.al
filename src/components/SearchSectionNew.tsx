          ...
          {showAiWarning && searchTerm.trim().length > 0 && (
            <div className="rounded-xl border border-warning/40 bg-warning/10 px-4 py-3 text-left">
              ...
              <div className="text-xs text-muted-foreground">
                Set <span className="font-mono">VITE_OPENAI_API_KEY</span> in Vercel (or <span className="font-mono">.env</span>) for real embeddings. Until then, semantic ranking may be unreliable.
              </div>
            </div>
          )}
